...
```
┌─────────────────────────────────────────────────────────────────┐
│  Recipes                                [Search...] [+ Add Recipe]│
├─────────────────────────────────────────────────────────────────┤
│  Category: [All ▼]  Cuisine: [All ▼]  [⭐ Favorites]           │
├─────────────────────────────────────────────────────────────────┤
│                                                                  │
│  ┌─────────────┐  ┌─────────────┐  ┌─────────────┐              │
│  │ [Photo]     │  │ [Photo]     │  │ [Photo]     │              │
...
│  │ 🍽 4 servings│  │ 🍽 4 servings│  │ 🍽 6 servings│              │
│  └─────────────┘  └─────────────┘  └─────────────┘              │
│                                                                  │
│  ┌─────────────┐  ┌─────────────┐  ┌─────────────┐              │
│  │ [Photo]     │  │ [Photo]     │  │ [Photo]     │              │
...
│  └─────────────────────────────────────────────────────────────┘│
│                                                                  │
│  ⏱ 30 minutes  |  🍽 [4 ▼] servings  |  Category: Dinner        │
│                                                                  │
│  Can make: ✅ Yes (have all ingredients)           [Cook Now]   │
│                                                                  │
│  Ingredients                                                     │
│  ────────────                                                    │
│  □ 1 lb chicken breast, diced          ✅ In stock (2 lbs)     │
│  □ 2 cups mixed vegetables             ✅ In stock              │
│  □ 3 tbsp soy sauce                    ⚠️ Low stock (1 tbsp)   │
│  □ 1 tbsp sesame oil                   ✅ In stock              │
│  □ 2 cloves garlic, minced             ✅ In stock              │
│                                                                  │
│  Instructions                                                    │
│  ────────────                                                    │
│  1. Cut chicken into 1-inch cubes                               │
│  2. Heat oil in wok over high heat                              │
│  3. Add chicken, cook 5-6 minutes until golden                  │
│  4. Add vegetables, stir fry 3-4 minutes                        │
│  5. Add soy sauce and garlic, cook 1 minute                     │
│  6. Serve over rice                                             │
│                                                                  │
...
```
┌─────────────────────────────────────────────────────────────────┐
│  Meal Plan - Week of Feb 3, 2026            [< Prev] [Next >]   │
├─────────────────────────────────────────────────────────────────┤
...
│  └───────────────────────────────────────────────────────────┘  │
│                                                                  │
│  Servings: [4]  (Recipe default: 4)                             │
│                                                                  │
│  For: [✓] Alex  [✓] Jordan  [ ] Sam (vegetarian)               │
│                                                                  │
│                                              [Cancel] [Add]     │
└─────────────────────────────────────────────────────────────────┘
```

...
- [x] **[1] [CRITICAL]** Products table with all required fields
  - Test: `\d products` shows name, barcode, category, min_stock, attributes

- [x] **[2] [CRITICAL]** Product CRUD endpoints

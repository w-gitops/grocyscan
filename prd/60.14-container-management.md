...
├─────────────────────────────────────────────────────────────────┤
│  Home > Kitchen > Pantry                              [🔍 Search]│
├─────────────────────────────────────────────────────────────────┤
│                                                                  │
│  📁 Shelf 1                                           12 items  │
│  📁 Shelf 2                                            8 items  │
│  📁 Shelf 3                                           15 items  │
│  📦 Snack Bin (container)                              5 items  │
│  📦 Canned Goods Box (container)                      20 items  │
│                                                                  │
│  ─────────────────────────────────────────────────────────────  │
│  Recent items in Pantry:                                        │
│  • Cheerios (Shelf 2) - exp Mar 15                              │
│  • Black Beans x4 (Canned Goods Box)                            │
│  • Granola Bars (Snack Bin) - exp Apr 1                         │
└─────────────────────────────────────────────────────────────────┘
```
...
│  Type: Plastic Bin                                              │
│  QR: K3D-SNACK-X                                   [Print Label]│
│                                                                  │
│  Contents (5 items):                                            │
│  ┌───────────────────────────────────────────────────────────┐  │
│  │ Granola Bars (6 pack)           qty: 2     exp: Apr 1     │  │
│  │ Trail Mix                       qty: 1     exp: Jun 15    │  │
│  │ Protein Bars                    qty: 3     exp: May 20    │  │
│  │ Dried Fruit                     qty: 1     exp: Jul 1     │  │
│  │ Crackers                        qty: 1     exp: Mar 30    │  │
│  └───────────────────────────────────────────────────────────┘  │
│                                                                  │
│                                              [+ Add to Container]│
└─────────────────────────────────────────────────────────────────┘
...
|------|------|-------------|
| `property` | 🏠 | Home, Vacation House |
| `building` | 🏢 | Main House, Garage |
| `floor` | ⬆️ | First Floor, Basement |
| `room` | 🚪 | Kitchen, Bedroom |
| `zone` | 📍 | Fridge, Cabinet |
| `shelf` | 📚 | Shelf 1, Top Drawer |
| `other` | 📁 | Custom |

...
- **Decision:** Vue 3 + Quasar PWA is the production architecture.
- **Status:** Superseded by DEC-052
- **Rationale:** PRDs describe a comprehensive Vue/Quasar PWA architecture with offline support, service workers, and installability.
- **Phase:**
  - **[CORE]** Vue 3 + Quasar + Vite + Pinia + Vue Router.
  - **[CORE]** PWA manifest, service worker (vite-plugin-pwa/Workbox), offline support.
  - **[FLEX]** Capacitor for native iOS/Android app-store builds if needed.
- **Notes:**
  - Deployment: Vue frontend (port 3335) + FastAPI backend (port 3334).

### DEC-052: Deprecate NiceGUI frontend
- **Decision:** Remove NiceGUI code and dependencies. Vue 3 + Quasar is the sole frontend.
- **Status:** Approved
- **Date:** 2026-02-04
- **Rationale:** NiceGUI was used for rapid prototyping during early development. Vue/Quasar frontend now has full feature parity (ScanPage, ProductsPage, LocationsPage, SettingsPage complete). Removing NiceGUI reduces codebase complexity (~3,500 lines), eliminates duplicate UI implementations, and clarifies architecture.
- **Phase:** **[CORE]** - Immediate removal
- **Consequences:**
  - Reduced codebase complexity
  - Single frontend to maintain
  - Clearer architecture documentation
  - All PRD documentation updated to reflect Vue-only architecture

...
The Vue 3 + Quasar frontend serves on port 3335, with the FastAPI backend on port 3334. Reverse proxy should route `/api` to port 3334 and all other traffic to port 3335.
...
|---------|---------------|---------|---------------|
| Homebot API | 3334 | FastAPI backend | `homebot.example.com/api` |
| Homebot UI | 3335 | Vue.js SPA | `homebot.example.com` |

...
The Vue 3 + Quasar frontend is the production stack for GrocyScan. The frontend serves from port 3335 as a Vite-built SPA, with API calls proxied to FastAPI on port 3334. See [DEC-052](91.14-decision-log.md#dec-052-deprecate-nicegui-frontend) for deprecation details.
